...
optimizer = optimizer.SGD(linear_model.parameters(), lr=0.01, momentum=0.5)
...
print('Model params:', list(linear_model.parameters()))  # https://graphsketch.com/

# Test on unseen data
test_set = [(0.5, 0.5), (1.5, 1.5), (2, -1), (-3, -3)]
linear_model.eval()
for test_data in test_set:
    out = linear_model(torch.tensor([test_data], dtype=torch.float, requires_grad=False))
